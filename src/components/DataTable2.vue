      ...
      <div class="min-w-full inline-block align-middle">
        <div class="flex-grow">
          <table class="relative min-w-full divide-y divide-gray-200 dark:divide-gray-700 border-t">
            <DataTableHeader2 :schema="props.schema" />
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
              <DataTableRow2 v-for="record in props.records"
                            :key="record.id"
                            :schema="props.schema"
                            :record="record"/>
            </tbody>
...
import DataTableHeader2 from '@/components/DataTableHeader2.vue'
import DataTableRow2 from '@/components/DataTableRow2.vue'
