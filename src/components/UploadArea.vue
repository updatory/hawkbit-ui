<template>
  <div>
    ...
    >
      <input id="upload-area" type="file" class="sr-only" @change.stop.prevent="onChange" />
      ...
      <span class="mt-2 block text-sm text-gray-500">Maximum upload file size: 5 GB</span>
    </label>
  </div>
</template>
